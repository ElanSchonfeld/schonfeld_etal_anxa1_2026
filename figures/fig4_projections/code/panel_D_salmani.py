#!/usr/bin/env python3
"""Figure 4 panel D: mouse (Salmani) projection enrichment by driver group."""
import sys
...
def main():
    mat, sig = load_panel("panelD_salmani")
    ...
    plot_grouped_broad_heatmap(
        ax, mat, row_color, title="Mouse (Salmani et al.)",
    ...
    figio.save_panel(fig, OUT / "panelD_salmani_projection")
