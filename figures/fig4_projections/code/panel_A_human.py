#!/usr/bin/env python3
"""Figure 4 panel A: human (Allen HMBA-BG) broad-region projection enrichment by driver group."""
import sys
...
def main():
    mat, sig = load_panel("panelA_human")
